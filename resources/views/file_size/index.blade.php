   ...
   <br>    
	 <div class="card">
              <div class="card-header">
              	<h4 class="float-left">File Size List</h4>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
					@foreach($file_size_list  as $key => $value)
					<tr>
						<td>{{$key + 1}}</td>
						...
						<td>
							...
							<form method="post" action="{{url('file-size/'.$value->id)}}">
								@csrf
								@method('DELETE')
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Add  File Size</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>

				<form id="file_size_form">
					<div class="modal-body">
						<input required="" type="text" class="form-control" name="file_size" id="file_size" placeholder="File Size">
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						<button type="button" class="btn btn-primary file_size">Save</button>
					</div>
				</form>
			</div>
		</div>
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalTable" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="editModalTable">Edit File Size</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
	...
	<script type="text/javascript">
		$(".file_size").click(function (){
        $(".error_msg").html('');
        var data = new FormData($('#file_size_form')[0]);
